...
ORDER BY 1;
   ...
   SELECT ANO, ESTADO FROM SENSO WHERE ANO='2013'; 
    ...
    SELECT ANO, ESTADO, NOME_MUN, POPULACAO FROM SENSO WHERE ANO='2014' AND COD_UF='11'
    UNION
    SELECT ANO, ESTADO, NOME_MUN, POPULACAO FROM SENSO WHERE ANO='2013' AND COD_UF='11'
